...
class Pipeset extends dataset_1.DataSet {
    ...
    notPipeQuery(item) {
        return !((core_1.Utility.instanceof(item, memoperation_1.MemOperation)) || typeof item === "function");
    }
    isPipeQuery(item) {
        return ((core_1.Utility.instanceof(item, memoperation_1.MemOperation)) || typeof item === "function");
    }
    ...
    get(...expression) {
        let getResultFromPipesAsPromise = function (pipes, value) {
            ...
            let valuePromise = (core_1.Utility.instanceof(value, Promise)) ? value : Promise.resolve(value);
            if (pArray.length === 0)
                return valuePromise;
        ...
        return this.source.query.apply(this.source, expressions.left).then((r) => {
            ...
            if (core_1.Utility.instanceof(pipeResult, Promise)) {
